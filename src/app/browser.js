...
export function continuityBonusForMatches(matchCount) {
...
export function describeEconomyPath({ openingBuy = "full_buy", outcomes = [], startingBank = 74 }) {
...
export function summarizeReadPressure(recentOpenings = []) {
...
export function rosterPrice(ids) {
